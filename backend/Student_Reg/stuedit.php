<?php 
    ...
    $stmt->execute([
        ...
        if(isset($_SERVER['REQUEST_METHOD'])&& $_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $stmt=$pdo->prepare("UPDATE students SET name=:name,age=:age,phone=:phone,gender=:gender,address=:address  WHERE id=:id");
            $stmt->execute([
                'name'=>$studentName,
                'age' => $age,
                'phone' => $phone,
                ...
                <div class="container mt-5">
                    <div class="card mx-auto shadow-sm" style="max-width: 600px;">
                        <div class="card-header bg-success text-white">
                            <h4 class="mb-0">Edit Students Data</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="age" class="form-control" value="<?= $stu["age"] ?>"
                                        required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" value="Male"
                                            <?= ($stu['gender'] == 'Male') ? 'checked' : '' ?>>
                                        <label class="form-check-label">Male</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" value="Female"
                                            <?= ($stu['gender'] == 'Female') ? 'checked' : '' ?>>
                                        <label class="form-check-label">Female</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" value="Other"
                                            <?= ($stu['gender'] == 'Other') ? 'checked' : '' ?>>
